...
- Give tags a plus/minus option
  - clicking a tag name switches to showing only those tags
  - plus marks it as an AND operation
  - minus marks it as AND NOT
- prettify the UI


In the Edit UI, escape should cancel